...
final class PlanejamentoModel {
    ...
    * @return string
    */
    public function setNome_operador(string $nome_operador): PlanejamentoModel{
    ...
    * @return string
    */
    public function setNumero_cliente(string $numero_cliente): PlanejamentoModel{
    ...
    * @return string
    */
    public function setCpf_cliente(string $cpf_cliente): PlanejamentoModel{
